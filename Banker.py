...
class BankAccount:
    def __init__(self, account_holder, account_number, password, balance=0.0, savings_balance=0.0, loan_limit=5000.0):
    ...
    def display_account_details(self):
        ...
        print(f"Loan Limit: ${self.loan_limit:.2f}")
...
class SavingsAccount(BankAccount):
    def __init__(self, account_holder, account_number, password, balance=0.0, savings_balance=0.0, loan_limit=5000.0,
                 interest_rate=0.02):
        super().__init__(account_holder, account_number, password, balance, savings_balance, loan_limit)
